...
# Une colonne (équipe ou réserve) a 3 places ; un monstre en occupe autant que
# sa taille (1 à 3) mais n'a qu'une entrée, les entrées vides (0) étant tassées
# en fin de colonne. Relevé sur des sauvegardes du jeu (Rhapthorne II, taille 3,
# seul en équipe ; Tyrantosaure + Sanglinaire, 1 + 2, en réserve).
PLACES_PAR_COLONNE = 3
SURNOM_VIDE = b'\xe3\x1b'                # case d'équipe vide dans le résumé
...
# 0x0B, le 9 de 0x0C ou 0x0D, le 10 de 0x0D ; 0x0B apparaît dès la fin du
# chapitre 7 (championnat), jamais avant. Minimums de l'un selon l'autre
# (0x0A, jamais observé, est toléré au chapitre 8) ; hors de ces paires,
# l'éditeur avertit.
